...
man_data <- man_data %>% 
  ...
  select(-id, -boro, -classification_code, -`3_classification_code`, -report_date, -patrol, -internal_code, -park, -end_date, -end_time)
...
write_csv(man_data, "data/Manhattan_tidy_nohome.csv")
```
